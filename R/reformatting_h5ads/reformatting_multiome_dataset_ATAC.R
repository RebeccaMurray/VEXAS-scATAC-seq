...
multiome.data.file <- "/gpfs/commons/home/rmurray/rscripts/VEXAS_GoTChA_signac/data/multiome_geo/ATAC_only_2.h5ad"

print(paste0("File name: ", multiome.data.file))
print("Beginning conversion...")

Convert(multiome.data.file, dest = "h5seurat", assay = "ATAC", overwrite = FALSE, verbose = TRUE)
